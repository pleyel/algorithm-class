...
#   - 링 버퍼는 큐와 유사하지만, 선형/원형큐는 데이터가 가득 찼을 때 추가 삽입이 불가능.
#   - 반면 링 버퍼는 덮어쓰기 기능을 통해 포화 상태에서 새로운 데이터를 계속해서 추가할 수 있음.

from circular_queue_class import CircularQueueOneSlotEmpty

class RingBuffer:
    def __init__(self, capacity):
        # 내부 배열에 한 칸 비움 방식의 원형큐 사용
